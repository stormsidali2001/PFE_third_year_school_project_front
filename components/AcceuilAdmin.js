...
const AcceuilAdmin = props => {
    return (
        <div className="text-[#1A2562] bg-[#F8FDFF] pt-[100px] pl-[100px] font-xyz px-12 flex flex-col-reverse lg:flex-row space-y-3 py-10 lg:h-[100vh] h-fit w-[100vw] items-center justify-center">
            ...
            <img src="AceeuilAdmin.jpg" className="md:h-[400px] w-full object-contain mix-blend-darken"/>
        </div>
    )
}
