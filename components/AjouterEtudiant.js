...
const AjouterEtudiant = props => {
    ...
    return (
        ...
        className = " border border-primary border-blue-700  rounded-full outline-none h-[50px] w-[350px] px-3"
        onChange = {
        ...
        className = "border border-primary border-blue-700 rounded-full outline-none h-[50px] w-[500px] px-3"
        onChange = {
        ...
        input placeholder = { moyen }
        className = "border border-primary border-blue-700 rounded-full outline-none h-[50px] w-[150px] px-3"
        onChange = {
            (e) => setMoyen(e.target.value) }
        /> <
        /div>  <
        /div> <
        /div> <
        ...
        <
        button type = "submit"
        className = "bg-blue-500 h-[50px] w-[200px] rounded-full shadow-lg text-[24px]" > Valider < /button> <
        /div> <
        /form>
    )
}
