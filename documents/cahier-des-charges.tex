...
%-----------------gesttion deux --------------%
\newpage
\subsection{gestion équipe}\index{équipe}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/UseCase equipe.png}
...
\begin{tabularx}{1\textwidth} { | p{4cm} | >{\raggedright\arraybackslash}X |  }
 ...
 post conditions  &  Avoir une idée sur les équipes de meme promotion  \\
  \hline
\end{tabularx}
\captionof{table}{ CU consulter la liste des équipes}\label{tbl:nicetablelesstable}
\end{center}
...
\begin{tabularx}{1\textwidth} { | p{4cm} | >{\raggedright\arraybackslash}X |  }
 ...
 post conditions  &   L’étudiant s’affiche dans la liste des étudiants sans groupe  \\
  \hline
\end{tabularx}
\captionof{table}{ CU Quitter une équipe}\label{tbl:nicetablelesstable}
\end{center}
%-------------------------------------------------------------------------------------------------------%
%-----------------gesttion trois --------------%

\newpage
\subsection{gestion affectation et thèmes }\index{thèmes}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/UseCase themes.png}
...
\begin{tabularx}{1\textwidth} { | p{4cm} | >{\raggedright\arraybackslash}X |  }
 ...
 post conditions  &   Le thème s’envoie aux administrateur pour validation  \\
  \hline
\end{tabularx}
\captionof{table}{ CU Proposer un thème}\label{tbl:nicetablelesstable}
\end{center}
%-------------------------------------------------------------%
...
\begin{tabularx}{1\textwidth} { | p{4cm} | >{\raggedright\arraybackslash}X |  }
 ...
 post conditions  &   Le thème s'affiche dans la page des thèmes proposées  \\
  \hline
\end{tabularx}
\captionof{table}{ CU valider un thème}\label{tbl:nicetablelesstable}
\end{center}
%-------------------------------------------------------------------------------------------%
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/UseCase document.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/UseCase encadrement.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Pictures/UseCase soutenance.png}
...
\begin{tabularx}{1\textwidth} { | p{4cm} | >{\raggedright\arraybackslash}X |  }
 ...
 post conditions  & notification s'envoie au les membres d'equipe et l'administrateur \\
  \hline
\end{tabularx}
\captionof{table}{ CU l’autorisation de soutenance}\label{tbl:nicetablelesstable}
\end{center}
%-----------------------------------------------------------------%
...
\begin{tabularx}{1\textwidth} { | p{4cm} | >{\raggedright\arraybackslash}X |  }
 ...
 post conditions  & jury est affectée à une équipe \\
  \hline
\end{tabularx}
\captionof{table}{ CU préciser la jury}\label{tbl:nicetablelesstable}
\end{center}
%-------------------------------------------------------------------------------------%
