...
const addStudent = ({toastsRef}) => {
    ...
    const [manyClick , setManyClick] = useState(true)
                ...
                <form className = {`h-[550px] w-[650px] bg-white/70 backdrop-blur-sm shadow-lg rounded-xl flex-col space-y-10 items-center justify-center relative text-[23px] ${oneclick === true ? "flex" : "hidden"}`}>
                    ...
                    <table>
                        <tr className="">
                            ...
                            <td>
                                <input className="h-[40px] w-[230px] rounded-lg bg-white/10 shadow-md backdrop-blur-sm outline-none px-3 text-[18px] font-thin" placeholder="Matricule..." onChange={(e)=>{setMatricule(e.target.value)}}/>
                            </td>
                        </tr>
                        <tr className="">
                       ...
                       <tr className="">
                        ...
                        <tr className="">
                            <td className="py-2 pr-12">Promotion :</td>
                            <td>
                                <input className="h-[40px] w-[230px] rounded-lg bg-white/10 shadow-md backdrop-blur-sm outline-none px-3 text-[18px] font-thin" placeholder="Promotion..." onChange={(e)=>{setPromotion(e.target.value)}}/>
                            </td>
                        </tr>
                    </table>
