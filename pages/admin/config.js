        ...
        <div>
            ...
            <div className="bg-background space-x-10 h-screen w-screen relative flex flex-row items-center justify-center font-xyz text-textcolor">
                <div className="flex items-center justify-center relative flex-col">
                    ...
                    <div className={`absolute h-[300px] w-[500px] bg-white/80 shadow-lg rounded-xl flex-col flex items-center justify-center ${validerEquipes === true ? "flex":"hidden"}`}>
                        <div>Valider les équipes :</div>
